...
- (BOOL)launchEnrollment {
    ...
    if(enrolledAccount) {
        ...
        if (nil != vpnConfig)
        {
            [MicrosoftTunnelDelegate.sharedDelegate setVpnConfiguration:vpnConfig];
            [MicrosoftTunnelDelegate.sharedDelegate configureSDK];
        }
        else
        {
...
- (void)enrollmentRequestWithStatus:(IntuneMAMEnrollmentStatus *)status
{
    ...
    // MicrosoftTunnelApi::Initialize is called during the singleton construction
